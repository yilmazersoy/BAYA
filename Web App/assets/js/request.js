$(document).ready(function(){
    ...
    function getLocation(location){
        $.ajax({
            url: "https://geocode.maps.co/reverse?lat=" + location.coords.latitude+ "&lon=" + location.coords.longitude + "&api_key=658ace6e52628560305441pncd1f932",
            type: "GET",
    ...
    $("#search-next-btn").click(function(){
        $("#loading").fadeIn();
        $.ajax({
            url: "https://bayaapi.bsp-academy.com/AddAidNotice/AddDataAitNotion",
            type: "POST",
    ...
    $("article.street").click(function(){
        ...
        $("#loading").fadeIn();
        $.ajax({
            url: "https://bayaapi.bsp-academy.com/AidNotice/AddDataAitNotion",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
                "county": county,
